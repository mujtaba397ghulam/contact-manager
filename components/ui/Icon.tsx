...
interface IconProps {
  name: 'search' | 'filter' | 'star' | 'edit' | 'delete' | 'add' | 'email' | 'phone' | 'company' | 'moon' | 'sun' | 'bell' | 'menu' | 'close' | 'check' | 'upload' | 'download';
...
export default function Icon({ name, size = 'medium', className = '' }: IconProps) {
  ...
  const icons = {
    ...
    filter: 'M12 6V4m0 2a2 2 0 100 4m0-4a2 2 0 110 4m-6 8a2 2 0 100-4m0 4a2 2 0 110-4m0 4v2m0-6V4m6 6v10m6-2a2 2 0 100-4m0 4a2 2 0 110-4m0 4v2m0-6V4',
